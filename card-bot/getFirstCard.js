...
//////////////////////////////////////////////////////
   var json = event;
    ...
    var isGetFirstCard=json.isGetFirstCard;
    ...
    if (isMyTrump=="N"){
        for (var i = 0; i < totalCardsOnHand; i++) {
            ...
            if (isJackFound=="N"){
                var isLarge=isCardLarge(cardToPlay.faceValue,cardsOnHand[i].faceValue);
                if(isLarge=="Y"){   // Find smaller one to play if no Jack
                    cardToPlay.cardType=cardsOnHand[i].cardType;
                    cardToPlay.faceValue=cardsOnHand[i].faceValue;
                }
            }
